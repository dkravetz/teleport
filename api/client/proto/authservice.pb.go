...
var fileDescriptor_ce8bd90b12161215 = []byte{
	...
	0xee, 0x63, 0xe5, 0x6d, 0x34, 0xe5, 0x52, 0xf6, 0x98, 0x54, 0x59, 0xc1, 0x93, 0xc3, 0xbd, 0x3a,
	0xff, 0x6d, 0xaf, 0xf3, 0xb2, 0x47, 0x35, 0x91, 0x73, 0x15, 0xde, 0xd3, 0x0a, 0x6a, 0xd1, 0x3b,
	0x15, 0x05, 0xfa, 0xd2, 0x87, 0xb7, 0x0c, 0x99, 0x1f, 0x6a, 0x2c, 0xf1, 0x13, 0x7f, 0x50, 0xa7,
	0x9a, 0xc1, 0x30, 0xc2, 0xba, 0xbc, 0x4c, 0x55, 0xc5, 0xbc, 0x96, 0xab, 0xd4, 0x0a, 0xdf, 0xfd,
	0xd7, 0x96, 0xf6, 0xdd, 0xf7, 0x5b, 0xda, 0xbf, 0x7e, 0xbf, 0xa5, 0xfd, 0xee, 0xfb, 0x2d, 0xed,
	0x7c, 0x8a, 0x52, 0xec, 0xfe, 0x4f, 0x00, 0x00, 0x00, 0xff, 0xff, 0xf7, 0x7c, 0x88, 0xfa, 0x7b,
	0x42, 0x00, 0x00,
}
...
type AuthServiceClient interface {
	...
	GetOIDCConnector(ctx context.Context, in *types.GetResourceWithSecretsRequest, opts ...grpc.CallOption) (*types.OIDCConnectorV2, error)
	// GetOIDCConnectors gets all current OIDC connector resources.
	GetOIDCConnectors(ctx context.Context, in *types.GetResourcesWithSecretsRequest, opts ...grpc.CallOption) (AuthService_GetOIDCConnectorsClient, error)
	...
	DeleteOIDCConnector(ctx context.Context, in *types.DeleteResourceRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *authServiceClient) GetOIDCConnector(ctx context.Context, in *types.GetResourceWithSecretsRequest, opts ...grpc.CallOption) (*types.OIDCConnectorV2, error) {
...
func (c *authServiceClient) GetOIDCConnectors(ctx context.Context, in *types.GetResourcesWithSecretsRequest, opts ...grpc.CallOption) (AuthService_GetOIDCConnectorsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_AuthService_serviceDesc.Streams[8], "/proto.AuthService/GetOIDCConnectors", opts...)
	if err != nil {
		return nil, err
	}
	x := &authServiceGetOIDCConnectorsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type AuthService_GetOIDCConnectorsClient interface {
	Recv() (*types.OIDCConnectorV2, error)
	grpc.ClientStream
}

type authServiceGetOIDCConnectorsClient struct {
	grpc.ClientStream
}

func (x *authServiceGetOIDCConnectorsClient) Recv() (*types.OIDCConnectorV2, error) {
	m := new(types.OIDCConnectorV2)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *authServiceClient) DeleteOIDCConnector(ctx context.Context, in *types.DeleteResourceRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type AuthServiceServer interface {
	...
	// GetOIDCConnector gets an OIDC connector resource by name.
	GetOIDCConnector(context.Context, *types.GetResourceWithSecretsRequest) (*types.OIDCConnectorV2, error)
	// GetOIDCConnectors gets all current OIDC connector resources.
	GetOIDCConnectors(*types.GetResourcesWithSecretsRequest, AuthService_GetOIDCConnectorsServer) error
	// UpsertOIDCConnector upserts an OIDC connector in a backend.
	UpsertOIDCConnector(context.Context, *types.OIDCConnectorV2) (*empty.Empty, error)
	// DeleteOIDCConnector deletes an existing OIDC connector in a backend by name.
	DeleteOIDCConnector(context.Context, *types.DeleteResourceRequest) (*empty.Empty, error)
}
...
func (*UnimplementedAuthServiceServer) GetOIDCConnector(ctx context.Context, req *types.GetResourceWithSecretsRequest) (*types.OIDCConnectorV2, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetOIDCConnector not implemented")
}
func (*UnimplementedAuthServiceServer) GetOIDCConnectors(req *types.GetResourcesWithSecretsRequest, srv AuthService_GetOIDCConnectorsServer) error {
	return status.Errorf(codes.Unimplemented, "method GetOIDCConnectors not implemented")
}
...
func (*UnimplementedAuthServiceServer) DeleteOIDCConnector(ctx context.Context, req *types.DeleteResourceRequest) (*empty.Empty, error) {
...
func _AuthService_GetOIDCConnector_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetOIDCConnector(ctx, req.(*types.GetResourceWithSecretsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AuthService_GetOIDCConnectors_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(types.GetResourcesWithSecretsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(AuthServiceServer).GetOIDCConnectors(m, &authServiceGetOIDCConnectorsServer{stream})
}

type AuthService_GetOIDCConnectorsServer interface {
	Send(*types.OIDCConnectorV2) error
	grpc.ServerStream
}

type authServiceGetOIDCConnectorsServer struct {
	grpc.ServerStream
}

func (x *authServiceGetOIDCConnectorsServer) Send(m *types.OIDCConnectorV2) error {
	return x.ServerStream.SendMsg(m)
}
...
func _AuthService_DeleteOIDCConnector_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).DeleteOIDCConnector(ctx, req.(*types.DeleteResourceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
