...
func (t *TerminalHandler) promptMFAChallenge(ws *websocket.Conn) client.PromptMFAChallengeHandler {
	return func(ctx context.Context, proxyAddr string, c *authproto.MFAAuthenticateChallenge, promptDevicePrefix string) (*authproto.MFAAuthenticateResponse, error) {
		if len(c.U2F) == 0 {
